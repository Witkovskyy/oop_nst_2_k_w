 ...
 *
 * @details Implements the behavior implied by the function name.
 * @param file Filesystem path or filename.
 * @return Result of the operation.
 */
 ...
 *
 * @details Implements the behavior implied by the function name.
 * @param txtEasy Parameter.
 * @param btnX Parameter.
 * @param btnY Parameter.
 * @return Result of the operation.
 */
 ...
 *
 * @details Implements the behavior implied by the function name.
 * @param txtT1 Parameter.
 * @param btnX Parameter.
 * @param timeY Parameter.
 * @return Result of the operation.
 */
 ...
 *
 * @details Implements the behavior implied by the function name.
 * @param isEngineThinking Parameter.
 * @return Result of the operation.
 */
 ...
 *
 * @details Implements the behavior implied by the function name.
 * @param validMoves Move data/descriptor.
 * @return Result of the operation.
 */
 ...
 *
 * @details Implements the behavior implied by the function name.
 * @param pieceMoved Move data/descriptor.
 * @return Result of the operation.
 */
 ...
 */
                    ...
                    if (realPiece) {
                        ...
                        /**
                         * @brief Perform `computeZobristHash`.
                         *
                         * @details Documentation for `computeZobristHash`.
                         * @return Result of the operation.
                         */
                        board->computeZobristHash();
                        board->positionHistory.push_back(board->zobristKey);
                    ...
                    if (board->isKingInCheck(currentPlayer)) {
                        if (board->isCheckMate(currentPlayer)) {
                             ...
                             * @brief Set string.
                             *
                             * @details Documentation for `setString`.
                             * @param currentPlayer Parameter.
                             * @return Result of the operation.
                             */
                            statusText.setString("MAT!\nWygrywa gracz:\n" + string(currentPlayer == 0 ? "CZARNY" : "BIALY"));
